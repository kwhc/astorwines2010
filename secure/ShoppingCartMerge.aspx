<%@ Page Title="" Language="VB" MasterPageFile="~/noColumns.master" AutoEventWireup="false" CodeFile="ShoppingCartMerge.aspx.vb" Inherits="ShoppingCartMerge" %>
...
<div class="no-column-page">
    ...
    <ItemTemplate>
        <table class="cart-table">
            <tr>
		       ...
		       <td class="cartQty">
		            <igtxt:WebNumericEdit id="wneQuantity" runat="server" BackColor="White" 
					    ReadOnly="false" Value='<%#DataBinder.Eval(Container.DataItem, "Quantity", "{0:#####}")%>' DataMode="Int"  MinValue="1" MaxValue="999" Nullable="False" CssClass="qty wneQty">
    ...
    <table class="cart-table alt-row">
       <tr>
	    ...
	    <td class="cartQty">			
	        <igtxt:WebNumericEdit id=wneQuantity runat="server" BackColor="White" Font-Bold="False" ReadOnly=false Value='<%#DataBinder.Eval(Container.DataItem, "Quantity", "{0:#####}")%>' DataMode="Int"  MinValue="1" MaxValue="999" Nullable="False" CssClass="qty wneQty">
	        </igtxt:WebNumericEdit> 							
	    </td>
    ...
    <div id="action-container" class="clearfix">
        ...
        <div Class="checkout-button-container clearfix" >
            <asp:ImageButton ID="imgbAddAllCheckOut" runat="server" ImageUrl="~/images/buttons/btn_add_all_items.jpg" class="checkout-button" OnClientClick="_gaq.push(['_trackEvent', 'Add to Cart', 'Add All', 'Merge Cart', 'value']);" />
        </div>
        <div class="checkout-button-container clearfix">
            <asp:ImageButton ID="imgbCheckOut" runat="server" ImageUrl="~/images/buttons/btn_proceed-to-checkout.gif" class="checkout-button" />
        </div>
