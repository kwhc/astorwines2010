...
Partial Class as_master_1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        upcomingClasses.connectionString = _webConfig.getConnStr
        tuesdays.Visible = (Now.DayOfWeek = DayOfWeek.Tuesday)
        accountNavigation.Visible = (Context.User.Identity.Name <> "")
    ...
    Protected Sub SnoothJS()
        ...
        Else
            Try
                ...
                End If
                dsOrder = Orders.GetOrderForCustomerFormatted(_oWebCommon.GetCustomerID(), _sInum)
    ...
    End Sub
    'Private Sub ViemoScript()
    '    ' Define the name, type and url of the client script on the page.
    '    Dim csname As String = "VimeoScript"
    '    Dim csurl As String = "~/js/VimeoInclude.js"
