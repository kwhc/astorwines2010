...
<asp:Panel runat="server" DefaultButton="imgbSignIn" ID="pnlLogIn">
    ...
    <div style="background-color:#fefefe;border:solid 1px #dddddd; padding:2rem;">
        ...
        <div class="input-container">
            ...
            <asp:TextBox ID="UserName" runat="server" Width="300px" TabIndex="8" Wrap="False" MaxLength="100" ValidationGroup="vgSignIn" CssClass="grey text-center" Placeholder="username@gmail.com" />
        ...
        <div class="input-container">
            ...
            <asp:TextBox ID="Password" runat="server" Width="300px" TextMode="Password" TabIndex="9" Wrap="False" MaxLength="10" ValidationGroup="vgSignIn" CssClass="grey text-center" />
    ...
    <div id="forgotPassword" class="background-dark" style="border:solid 1px #111111; padding:2rem;">

        <h4 class="text-light">Forgot your password?</h4>
        ...
        <div><asp:LinkButton ID="lnkbNewEmail" runat="server" Text="Reset My Password" /></div>
        <div><p>Enter your email address and a new password will be sent to you.*</p></div>
...
<div id="create-account-container" style="background-color:#fefefe;border:solid 1px #dddddd; padding:2rem;">
    <h3 style="margin-bottom:2rem;">Create an Account</h3>
      ...
      <asp:Panel runat="server" DefaultButton="imgbCreateAccount" ID="pnlCreate">
        ...
        <div class="input-container">        
            ...
            <asp:TextBox ID="NewUserName" runat="server" Width="300px" TabIndex="1" Wrap="False" MaxLength="100" ValidationGroup="vgSignInNew" Placeholder="username@gmail.com" CssClass="grey text-center" />
        ...
        <div class="input-container">        
            ...
            <asp:TextBox ID="VerifyNewUserName" runat="server" Width="300px" TabIndex="2" Wrap="False" MaxLength="100" ValidationGroup="vgSignInNew" AutoCompleteType="Disabled" CssClass="grey text-center" />
        ...
        <div class="input-container">
            ...
            <asp:TextBox ID="NewPassword" runat="server" Width="300px" TextMode="Password" TabIndex="3" Wrap="False" MaxLength="10" ValidationGroup="vgSignInNew" CssClass="grey text-center" />
        ...
        <div class="input-container">
            ...
            <asp:TextBox ID="VerifyNewPassword" runat="server" Width="300px" TextMode="Password" TabIndex="4" Wrap="False" MaxLength="10" ValidationGroup="vgSignInNew" CssClass="grey text-center" />
        ...
        <div class="input-container" style="text-align:left;"><asp:CheckBox ID="PersistNew" runat="server" Text=" Remember Me" TabIndex="5" Checked="True" /></div>

        <div class="input-container" style="text-align:left;"><asp:CheckBox ID="chkEmailNewsletterAdd" runat="server" Text=" I would like to receive emails about upcoming Sales, Free Tastings and Special Offers from <b>Astor Wines & Spirits.</b>" TabIndex="6" Checked="True" /></div>
        
        <div class="input-container" style="text-align:left;"><asp:CheckBox ID="chkEmailNewsletterACAdd" runat="server" Text=" I would like to receive emails including upcoming events, special offers and exclusive content from <b>Astor Center.</b>" TabIndex="6" Checked="True" /></div>
