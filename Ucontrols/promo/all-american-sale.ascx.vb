...
Partial Class Ucontrols_promo_made_in_usa
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        imgHero.ImageUrl = "~/images/promo/2014-07-all-american-sale/2014-07-All-American-Sale-E-mail-header.jpg"
        imgHero.Width = 526
        litHeadline.Text = "20% Off*<br/>All American Wines"
        litIntro.Text = "<p class='fancy'>June 30 - July 2</p>"
        ...
        "Sale prices valid 6/30/14 through 7/2/14 only, while current supplies last. For wines already on sale, the greater of (a) the pre-existing discount or (b) a discount of 20% off the full retail price will apply. No special orders; no case discounts; no further discounts."
        ...
        Page.Title = "20% Off All American Wines Today"
