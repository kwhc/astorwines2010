...
Partial Class Ucontrols_WUCQuickSearchNoAutoComplete
    ...
    Protected Sub imgbSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbbSearch.Click
