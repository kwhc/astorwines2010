...
<%@ Register TagName="copy" TagPrefix="uc" Src="~/Ucontrols/afterHoursCourierDetail.ascx" %>
    ...
    <ul class="grid">
        ...
        <asp:PlaceHolder runat="server" ID="phAfterHoursCourierService" Visible="false">
        <li>
            <div>
        ...
        <li>        
            ...
            <div style="font-style: italic; line-height:1.6em; margin-top:1em;">
                    ...
                    <ul style="list-style-type: circle; list-style-position: inside;">
                        <li>3rd Day &amp; Next Day orders will ship same day if ordered before 12pm EST</li>
                        <li>Shipping days are counted from date shipped</li>
                        <li>Weekends do not count as shipping days</li>
                        <li>Order date does not count as shipping day for 3rd Day orders</li>
