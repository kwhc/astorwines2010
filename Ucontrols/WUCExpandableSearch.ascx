<%@ Control Language="VB" AutoEventWireup="false" CodeFile="WUCExpandableSearch.ascx.vb" Inherits="Ucontrols_WUCExpandableSearch" %>
...
<div id="advancedSearchTabs">
    <ul> 
      <li><div class="advancedSearchTab"><a href="#wineSearch" class="selected">Wine Search</a></div></li> 
      <li><div class="advancedSearchTab"><a href="#spiritsSearch">Spirits Search</a></div></li>
      <li><div class="advancedSearchTab"><a href="#sakeSearch">Sake Search</a></div></li> 
    </ul> 
</div>
<div id="wineSearch" style="display: block; "><uc1:WUCWineSearch ID="WUCWineSearch1" runat="server" showheader="false" /></div> 
