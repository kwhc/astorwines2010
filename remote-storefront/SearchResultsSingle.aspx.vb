...
Partial Class SearchResultsSingle
    ...
    Private sSearchTypeShow As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsNothing(Request.QueryString("search")) Then
            ...
            imgbTellFriend.OnClientClick = "javascript:window.open('../AstorWinesEmailToFriend.aspx?item=" & sItem & "', 'EmailToAFriend', 'scrollbars=no,resizable=no,toolbar=no,status=no,width=415,height=600');"
    ...
    Private Function GetSakeDiscriminatorsForItem(ByVal sItem As String) As String
        ...
        Return sSakedesc
    End Function
    Private Sub SetStaffPickInfoForItem()
        Dim dsn As String = WebAppConfig.ConnectString
        Dim _oAstorCommon As New cAstorCommon
        Dim _odata As New cAstorWebData(dsn)
        Dim dsLocal As DataSet
            ...
            If oDS.Tables.Count > 0 Then
                If oDS.Tables(0).Rows.Count > 0 Then
                    With oDS.Tables(0).Rows(0)
                        ...
                        lblYouSave.Text = Convert.ToString(Convert.ToInt16(((.Item("botprcfl") - .Item("botprc")) / .Item("botprcfl")) * 100)) & "% <br />"
                        lblNewCasePrice.Text = "$" & .Item("casprc").ToString
                        lblOldCasePrice.Text = "$" & .Item("casprcfl").ToString
                        ...
                        If .Item("OnSale").ToString = "On Sale" Then
                            ...
                            lblYouSave.Visible = True
                            lblYouSaveLabel.Visible = True

                            lblNewCasePrice.CssClass = "dealPrice"
                            lblNewBottlePrice.CssClass = "dealPrice"
                            lblYouSave.CssClass = "dealPrice"
                        Else
                            lblOldBottlePrice.Visible = False
                            lblOldCasePrice.Visible = False
                            lblYouSave.Visible = False
                            lblYouSaveLabel.Visible = False
                        End If

                        ' special for books and accessories
                        If .Item("iLevel1Type") = 4 Then
                            lblBottlepriceLabel.Text = "Item Price:"
                            lblCaseLabel.Visible = False
                            lblOldCasePrice.Visible = False
                            lblNewCasePrice.Visible = False
                            With ddlType
                                .Items.Clear()
                                .Items.Add("Item(s)")
                                .Items(0).Value = "Item"
                        ...
                        If CBool(.Item("composite")) = True Then
                            lblBottlepriceLabel.Text = "Pack Price:"
                            lblCaseLabel.Visible = False
                            lblOldCasePrice.Visible = False
                            lblNewCasePrice.Visible = False
                            With ddlType
                        ...
                        If File.Exists(sFilePath & "lbl/" & .Item("item").ToString & "_lbl.jpg") Then
                            ...
                            thumb1Lnk.Text = "<a rel=""clearbox"" href=""images/itemimages/lbl/" & .Item("item").ToString & "_lbl.jpg"" >"
                            thumb1LnkEnd.Text = "</a>"
                        Else
                        ...
                        If File.Exists(sFilePath & "hr/" & .Item("item").ToString & "_hr.jpg") Then
                            ...
                            thumb2Lnk.Text = "<a rel=""clearbox"" href=""images/itemimages/hr/" & .Item("item").ToString & "_hr.jpg"" >"
                            thumb2LnkEnd.Text = "</a>"
                        Else
                        ...
                        If File.Exists(sFilePath & "alt/" & .Item("item").ToString & "_alt.jpg") Then
                            ...
                            thumb3Lnk.Text = "<a rel=""clearbox"" href=""images/itemimages/alt/" & .Item("item").ToString & "_alt.jpg"" >"
                            thumb3LnkEnd.Text = "</a>"
                        Else
